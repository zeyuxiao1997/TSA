...
class TSA_Fusion(nn.Module):
    ...
    def __init__(self, nf=64, nframes=5, center=2):
        ...
        self.lrelu = nn.LeakyReLU(negative_slope=0.1, inplace=True)
        self.conv3d = nn.Conv3d(nframes,nframes,3,1,1,bias=True)####################new
        self.conv3d_2d =  nn.Conv2d(nframes*nf,nf,3,1,1,bias=True)
    ...
    def forward(self, aligned_fea):
        ...
        fea = self.lrelu(self.fea_fusion(aligned_fea))+fea_3d
...
class EDVR(nn.Module):
    def __init__(self, nf, nframes, groups, front_RBs, back_RBs, center=None,
        ...
        Progressive_Block = functools.partial(arch_util.ProgressiveFusion_Block, nf=nf)
        ...
        if self.is_predeblur:
            ...
            if self.HR_in:
                ...
                self.conv_first = arch_util.ProgressiveFusion_Block_START(nf=nf)
        self.feature_extraction = arch_util.make_layer(Progressive_Block, front_RBs)
